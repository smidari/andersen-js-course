/**
 * Написать функцию, которая принимает массив с внутренними массивами, которая вернет объект и соберет
 * свойства этого объект на основании внутренних массивов.
 *
 * Пример вызова
