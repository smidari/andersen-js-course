 ...
 * Возвращаться должен результат забора по этой цепочке ключей. Если в процессе обращения к
 * какому-то свойству на 1ом или 2ом уровне, такого свойства не будет, нужно вернуть undefined.
 *
 * Пример вызова
